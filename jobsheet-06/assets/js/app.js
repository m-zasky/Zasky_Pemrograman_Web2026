...
// Fungsi generik untuk memuat data JSON ke tabel
async function muatDataGenerik(urlJson, keys) {
    ...
    try {
        ...
        dataList.forEach(function (item) {
            ...
            // Membuat cell <td> secara dinamis berdasarkan urutan keys
            let tdContent = "";
            keys.forEach(function (key) {
                tdContent += "<td>" + (item[key] ?? "") + "</td>";
            });

            // Menambahkan kolom tombol Aksi
            tdContent +=
                "<td>" +
